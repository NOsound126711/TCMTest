...
public class ParameterizedDiagnosis6Test {
	...
	public static Collection<String> generateData(){
		InputStream inputStream = ParameterizedDiagnosis6Test
				.class.getClassLoader()
				.getResourceAsStream("diagnosis_6.csv");
 	...
 	public static void setUp() throws Exception {
 		String name = ParameterizedDiagnosis6Test.class.getCanonicalName();
 		try{
