...
public class ParameterizedDiagnosisZungfuTest {
	...
	public ParameterizedDiagnosisZungfuTest(String datum){
		this.datum = datum;
	}
	
	@Parameters(name = "{index}: {0}")
	public static Collection<String> generateData(){
		InputStream inputStream = ParameterizedDiagnosisZungfuTest
				.class.getClassLoader()
				.getResourceAsStream("diagnosis_zungfu.csv");
 	...
 	public static void setUp() throws Exception {
 		String name = ParameterizedDiagnosisZungfuTest.class.getCanonicalName();
 		try{
